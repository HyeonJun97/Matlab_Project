...
%% Sample4 (겨울왕국-Let it Go)
[song1,songfs1] = audioread('Letitgo.mp3');
x = song1;
xFs = songfs1;
y = x2;
...
z = x*5 + y;
audiowrite('sample4.wav',z,xFs);
[x3,fs3] = audioread('sample4.wav');
...
rsong4 = max(abs(xcov(abs(Song1_compose),abs(X3_compose1),'coeff')))*100;