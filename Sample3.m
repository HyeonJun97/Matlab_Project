...
%% Sample3 (BTS-Idol)
[song1,songfs1] = audioread('idol.mp3');
x = song1;
xFs = songfs1;
y = x2;
...
z = x*5 + y;
audiowrite('sample3.wav',z,xFs);
[x3,fs3] = audioread('sample3.wav');
...
rsong3 = max(abs(xcov(abs(Song1_compose),abs(X3_compose1),'coeff')))*100;