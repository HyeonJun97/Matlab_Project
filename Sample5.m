...
%% Sample5 (ITZY-달라달라)
[song1,songfs1] = audioread('daladala.mp3');
x = song1;
xFs = songfs1;
y = x2;
...
z = x*5 + y;
audiowrite('sample5.wav',z,xFs);
[x3,fs3] = audioread('sample5.wav');
...
rsong5 = max(abs(xcov(abs(Song1_compose),abs(X3_compose1),'coeff')))*100;