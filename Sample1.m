...
%% Sample1 (장범준-노래방에서)
[song1,songfs1] = audioread('singroom.mp3');
x = song1;
xFs = songfs1;
y = x2;
...
z = x*5 + y;
audiowrite('sample1.wav',z,xFs);
[x3,fs3] = audioread('sample1.wav');
...
rsong1 = max(abs(xcov(abs(Song1_compose),abs(X3_compose1),'coeff')))*100;